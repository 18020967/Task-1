...
namespace Assignment1_RTS
{
    ...
    {
        public RangedUnit(int x, int y, int health, int speed, int attack, int range, int team, string symbol) : base(x, y, 110, 1, attack, 1, team, "O")
        {
            this.x = x;
            this.y = y;
            this.health = health;
